...
export const EditWorkspaceForm = ({ onCancle, initialValues }: EditWorkspaceFormProps) => {
        ...
        <div className="flex flex-col gap-y-4">
            ...
            <Card className="w-full h-full border-none shadow-none">
                <CardHeader className="flex flex-row items-center p-7 gap-x-4 space-y-0">
                    <Button variant="secondary" size="sm" onClick={onCancle ? onCancle : () => router.push(`/workspaces/${initialValues.$id}`)}>
                        <ArrowLeftIcon />
                        Back
                    </Button>
            ...
            <Card className="w-full h-full border-none shadow-none">
                <CardContent className="p-7">
                    <div className="flex flex-col">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Deleting a workspace is irreverseible and will remove all associated data
                        </p>
                        <DottedSeparator classname="py-7" />
                        <Button
                            className="mt-6 w-fit ml-auto"
