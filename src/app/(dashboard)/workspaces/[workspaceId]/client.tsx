        ...
        <div className="flex flex-col gap-y-4 col-span-1">
            <div className="bg-muted rounded-lg p-4">
                ...
                <ul className="flex flex-col gap-y-4">
                                ...
                                <Card className="shadow-none rounded-lg hover:opacity-75 transition">
                                    <CardContent className="p-4">
                                        ...
                                        <div className="flex items-center gap-x-2">
                                            ...
                                            <div className="size-1 rounded-full bg-neutrual-300" />
                    ...
                    <li className="hidden text-sm text-muted-foreground first-of-type:block">No Task found</li>
                </ul>
        ...
        <div className="flex flex-col gap-y-4 col-span-1">
            <div className="bg-white border rounded-lg p-4">
                ...
                <ul className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    <li className="hidden text-sm text-muted-foreground first-of-type:block">No Project found</li>
                </ul>
            </div>
        </div >
    )
        ...
        <div className="flex flex-col gap-y-4 col-span-1">
            <div className="bg-white border rounded-lg p-4">
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <li className="hidden text-sm text-muted-foreground first-of-type:block">No Member found</li>
                </ul>
            </div>
        </div >
    )
